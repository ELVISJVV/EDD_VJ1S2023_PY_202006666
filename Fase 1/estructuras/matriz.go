...
func (m *Matriz) GenerarImagen(nombre_imagen string) {
	...
	escribirArchivoDot(contenidoCSS, archivoCSS)
}
...
func (m *Matriz) generarHTML(nombre_imagen string) {
	...
	escribirArchivoDot(contenidoHTML, archivoHTML)
}


func (m *Matriz) LeerArchivoLayer(ruta string) {
...
func (m *Matriz) LeerArchivoCapa(ruta string) {
